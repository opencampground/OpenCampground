...
class DiscountTest < ActiveSupport::TestCase
  ...
  def test_charges_percent
    disc = Discount.new :name => 'test', :discount_percent => 8.00, :disc_appl_daily => true, :amount => 0.0
  ...
  def test_charges_duration
    disc = Discount.new :name => 'test', :discount_percent => 8.00, :duration => 2 # 2 day duration
    assert_equal 8.00, disc.charge(100.0, Charge::DAY, Date.new, 1) # 8% discount 
    assert_equal 8.00, disc.charge(200.0, Charge::DAY, Date.new, 2) # 8% discount 
    assert_equal 0.00, disc.charge(300.0, Charge::DAY, Date.new, 3) # 8% discount 
  end
  ...
  def test_charges_periods
    disc = Discount.new :name => 'test', :amount_daily => 1.23
